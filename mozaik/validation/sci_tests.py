...
class AverageFiringRate(Test):
    """Test if the distribution of the sheets average firing rates is significatively different than a predefined value
    or distribution"""
...
class DistributionAverageFiringRate(Test):
    """Test if the sheet average firing rates distributions is significatively different 
...
class CoefficientVariationISI(Test):
    """Test if the sheets distribution of the coefficient of variation of the Inter-Spike-Interval is significatively greater than a predefined value or distribution"""
...
class CorrelationCoefficient(Test):
    """Test if the sheets distribution correlation coefficient is significatively greater than a predefined distribution"""
